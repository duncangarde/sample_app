...
describe User do
	before do
	 @user = User.new(name: "duncan", email: "some@thing.com", password: "secure", password_confirmation: "secure")
	end
  ...
  it { should respond_to(:userrelationships) }
  ...
  describe "when password is blank" do
    before do
      @user = User.new(name: "example", email: "duncan@example.com", password: " ", password_confirmation: " ")
    end
    it { should_not be_valid }
  end
